...
describe("Project Utils", () => {
  describe("getProjectName", () => {
    it("should extract project name from path", () => {
      expect(getProjectName("/Users/test/Projects/myProject")).toBe(
        "myProject",
      );
      expect(getProjectName("/home/user/work/another-project")).toBe(
        "another-project",
      );
    });

    it("should sanitize special characters", () => {
      expect(getProjectName("/path/to/my.project@2025")).toBe(
        "my-project-2025",
      );
  ...
  describe("getHookStoragePath", () => {
    ...
    it("should handle projects with special characters", () => {
      ...
      expect(result).toContain(
        "/projects/package-name/prompts/2025-09-16-prompts.json",
      );
    });
