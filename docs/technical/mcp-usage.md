...
### v0.7.4 Unified Storage Architecture
As of v0.7.4, c0ntextKeeper features a unified storage architecture with intelligent path resolution, project-name based organization, and seamless global/local storage support. Archives are now organized by readable project names instead of cryptic hashes.
...
**Status**: ✅ v0.7.4 - Unified Storage Architecture
