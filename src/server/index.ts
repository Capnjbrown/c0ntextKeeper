...
const TOOLS: Tool[] = [
  {
    name: 'fetch_context',
    description: 'Fetch relevant archived context for the current task. Returns previously extracted problems, solutions, and implementations.',
    inputSchema: {
      type: 'object',
      properties: {
        query: {
  ...
  {
    name: 'search_archive',
    description: 'Search through archived context with advanced filters. Find specific implementations, errors, or decisions.',
    inputSchema: {
      type: 'object',
      properties: {
        query: {
  ...
  {
    name: 'get_patterns',
    description: 'Retrieve recurring patterns from archived sessions. Identifies common solutions and approaches.',
    inputSchema: {
      type: 'object',
      properties: {
        type: {
